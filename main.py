...
#
# try:
#     r = session.request('GET', 'https://www.avito.ru/orenburg/avtomobili/do-100000-rubley-ASgCAgECAUXGmgwWeyJmcm9tIjowLCJ0byI6MTAwMDAwfQ?cd=1&f=ASgCAQECAUDwChSsigEBRcaaDBZ7ImZyb20iOjAsInRvIjoxMDAwMDB9&moreExpensive=1&radius=200&s=104')
#     print(r.text)
